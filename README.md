...
import logo from battleshipLogo; // Tell Webpack this JS file uses this image

console.log(logo); battleshipLogo
...
render() {
  ...
  return <img src={process.env.PUBLIC_URL + battleshipLogo} />;
}
```
